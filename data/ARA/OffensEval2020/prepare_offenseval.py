...
training_path = "offenseval-ar-training-v1/offenseval-ar-training-v1.tsv"
test_dir = "offenseval-ar-testset-v1"
...
with open(os.path.join(test_dir, "offenseval-ar-test-v1.tsv"), "r") as f:
      test_text = list(map(lambda s: s.strip().split("\t"), f.readlines()))
      test_text = test_text[1:]

with open(os.path.join(test_dir, "offenseval-ar-labela-v1.csv"), "r") as f:
